define('app/renderer', ['app/util/camera', 'app/util/item', 'app/util/character', 'app/util/player', 'app/util/timer'], function (Camera, Item, Character, Player, Timer) {

    var Renderer = new Class({
        initialize: function (game, canvas, background, foreground) {
            this.game = game;
